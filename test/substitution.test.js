...
describe("Jordan's substitution tests", () => {
    ...
    it("should return false if the alphabet parameter isn't exactly 26 characters", () => {
        const actual = substitutionModule.substitution("thinkful", "poiuytrewqasdfghjklmnbv");
        expect(actual).to.be.false;
    });
    it("should return false if the alphabet parameter has duplicate characters", () => {
        const actual = substitutionModule.substitution("thinkful", "poiuytrewqaadfghjkllnbvcxz");
        expect(actual).to.be.false;
    });
});